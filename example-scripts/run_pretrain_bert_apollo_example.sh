...
TRAINING_ARGS="
    ...
    --logging_steps 1 \
    --output_dir experiments/bert-apollo-example \
    --apollo_info_output_file example-scripts/example-logs/bert-apollo-info/apollo_info \
...
mkdir -p example-scripts/example-logs/bert-apollo-info/
