...
TRAINING_ARGS="
    ...
    --logging_steps 1 \
    --output_dir experiments/gpt2-apollo-example \
    --apollo_info_output_file example-scripts/example-logs/gpt-apollo-info/apollo_info \
...
mkdir -p example-scripts/example-logs/gpt-apollo-info/
