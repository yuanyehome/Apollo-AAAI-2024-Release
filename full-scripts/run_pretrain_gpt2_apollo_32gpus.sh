...
export WANDB_NAME="GPT2-Apollo-32gpus"
...
TRAINING_ARGS="
    ...
    --logging_steps 1 \
    --output_dir experiments/gpt2-apollo-32gpus \
    --apollo_info_output_file logs/gpt2-apollo-32gpus/apollo-info/apollo_info \
...
mkdir -p logs/gpt2-apollo-32gpus/apollo-info/
